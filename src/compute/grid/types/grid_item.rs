...
impl GridItem {
    ...
    fn known_dimensions(
        ...
        let inherent_size = self
            ...
            .maybe_apply_aspect_ratio_with_box_sizing(aspect_ratio, self.box_sizing, padding_border_size)
    ...
    pub fn minimum_contribution(
        ...
        self.size
            .maybe_resolve(grid_area_size, |val, basis| tree.calc(val, basis))
            .maybe_apply_aspect_ratio_with_box_sizing(self.aspect_ratio, self.box_sizing, padding_border_size)
            .maybe_add(box_sizing_adjustment)
            .get(axis)
            .or_else(|| {
                self.min_size
