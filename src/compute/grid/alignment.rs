...
pub(super) fn align_and_position_item(
    ...
    inherent_size = inherent_size.maybe_apply_resolved_aspect_ratio(aspect_ratio, padding_border_size);
    min_size = min_size
        .maybe_apply_resolved_aspect_ratio(aspect_ratio, padding_border_size)
        .or(padding_border_size.map(Some))
        .maybe_max(padding_border_size);
    max_size = max_size.maybe_apply_resolved_aspect_ratio(aspect_ratio, padding_border_size);
